<?php
/*
Plugin Name: Custom Database Queryies
...
function database_examples_add_custom_field() {
	...
	$meta_value = 'Autumn';
	$query = "INSERT INTO $wpdb->postmeta( post_id, meta_key, meta_value ) VALUES ( %d, %s, %s )";
...
// My Example: select a column
function database_examples_get_all_terms() {
	global $wpdb;
...
function database_examples_display_settings_page() {
	...
	<div class="wrap">
		...
		<h2><?php esc_html_e( 'Select a Column of terms (my example)', 'myplugin' ); ?></h2>
		<?php  database_examples_get_all_terms(); ?>
